...
void CContactInfoTag::ToSortable(SortItem& sortable, Field field) const
{
...
{
  if (!m_isLoaded && !m_isInfoSetExternally) // If no metadata has been loaded from the contact file or set with SetInfo(), just return
    return "";
