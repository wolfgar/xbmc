...
namespace CONTACT_INFO
{
  ...
  public:
    ...
    /**
     * GetDateTimeTaken() -- Returns the EXIF DateTimeOriginal for current contact
     *
  ...
  protected:
     ...
     */
  private:
    bool       m_isLoaded;             // Set to true if metadata has been loaded from the contact file successfully
  };
}
